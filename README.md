# BblioCampus
    ...
    # Description = BiblioCampus est une application de gestion de bibliothèque universitaire. Elle est destinée aux bibliothécaires et aux étudiants d'un campus pour faciliter la gestion quotidienne du fonds documentaire.
    ...
    #Commandes d'exécution — comment lancer l'application : python main.py.
